...
CASES = [
    BenchCase("cpu-512-lab", "cpu", 512, "lab_l", 2, 5),
    BenchCase("cpu-1024-lab", "cpu", 1024, "lab_l", 1, 3),
    BenchCase("cpu-2048-lab", "cpu", 2048, "lab_l", 0, 1),
    BenchCase("cpu-1024-ycbcr", "cpu", 1024, "ycbcr_y", 1, 3),
    BenchCase("cpu-1024-hsv", "cpu", 1024, "hsv_v", 1, 3),
    BenchCase("gpu-512-lab", "cuda", 512, "lab_l", 2, 5),
    BenchCase("gpu-1024-lab", "cuda", 1024, "lab_l", 1, 3),
    BenchCase("gpu-2048-lab", "cuda", 2048, "lab_l", 0, 1),
]
