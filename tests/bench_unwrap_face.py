...
BASELINE_PATH = Path(__file__).with_name("bench_baselines") / "bench_unwrap_face.json"
...
CASES = [
    ...
    BenchCase("cpu-2048", "cpu", 2048, 1, 10),
    BenchCase("gpu-1024", "cuda", 1024, 1, 10),
    BenchCase("gpu-2048", "cuda", 2048, 1, 10),
]
...
def test_bench_unwrap_face(case: BenchCase, capsys: pytest.CaptureFixture[str]) -> None:
