...
CASES = [
    BenchCase("cpu-512-laplacian-rel", "cpu", 512, "laplacian", "relative_percentile", 2, 5),
    BenchCase("cpu-1024-laplacian-rel", "cpu", 1024, "laplacian", "relative_percentile", 1, 3),
    BenchCase("cpu-2048-laplacian-rel", "cpu", 2048, "laplacian", "relative_percentile", 0, 1),
    BenchCase("cpu-1024-sobel-rel", "cpu", 1024, "sobel", "relative_percentile", 1, 3),
    BenchCase("cpu-1024-fsgauss-rel", "cpu", 1024, "fs_gaussian", "relative_percentile", 1, 3),
    BenchCase("cpu-1024-laplacian-abs", "cpu", 1024, "laplacian", "absolute", 1, 3),
    BenchCase("gpu-512-laplacian-rel", "cuda", 512, "laplacian", "relative_percentile", 2, 5),
    BenchCase("gpu-1024-laplacian-rel", "cuda", 1024, "laplacian", "relative_percentile", 1, 3),
    BenchCase("gpu-2048-laplacian-rel", "cuda", 2048, "laplacian", "relative_percentile", 0, 1),
]
