...
BASELINE_PATH = Path(__file__).with_name("bench_baselines") / "bench_tone_curve.json"
...
CASES = [
    BenchCase("cpu-512-rgb_master", "cpu", 512, "rgb_master", 2, 10),
    BenchCase("cpu-1024-rgb_master", "cpu", 1024, "rgb_master", 1, 10),
    BenchCase("cpu-2048-rgb_master", "cpu", 2048, "rgb_master", 0, 10),
    BenchCase("cpu-512-r", "cpu", 512, "r", 2, 10),
    BenchCase("cpu-1024-r", "cpu", 1024, "r", 1, 10),
    BenchCase("cpu-2048-r", "cpu", 2048, "r", 0, 10),
    BenchCase("gpu-512-rgb_master", "cuda", 512, "rgb_master", 2, 10),
    BenchCase("gpu-1024-rgb_master", "cuda", 1024, "rgb_master", 1, 10),
    BenchCase("gpu-2048-rgb_master", "cuda", 2048, "rgb_master", 0, 10),
    BenchCase("gpu-512-r", "cuda", 512, "r", 2, 10),
    BenchCase("gpu-1024-r", "cuda", 1024, "r", 1, 10),
    BenchCase("gpu-2048-r", "cuda", 2048, "r", 0, 10),
]
...
def test_bench_tone_curve(case: BenchCase, capsys: pytest.CaptureFixture[str]) -> None:
