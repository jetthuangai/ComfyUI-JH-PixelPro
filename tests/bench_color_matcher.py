...
BASELINE_PATH = Path(__file__).with_name("bench_baselines") / "bench_color_matcher.json"
...
CASES = [
    BenchCase("cpu-512-ab", "cpu", 512, "ab", 2, 10),
    BenchCase("cpu-1024-ab", "cpu", 1024, "ab", 1, 10),
    BenchCase("cpu-2048-ab", "cpu", 2048, "ab", 0, 10),
    BenchCase("cpu-512-lab", "cpu", 512, "lab", 2, 10),
    BenchCase("cpu-1024-lab", "cpu", 1024, "lab", 1, 10),
    BenchCase("cpu-2048-lab", "cpu", 2048, "lab", 0, 10),
    BenchCase("gpu-512-ab", "cuda", 512, "ab", 2, 10),
    BenchCase("gpu-1024-ab", "cuda", 1024, "ab", 1, 10),
    BenchCase("gpu-2048-ab", "cuda", 2048, "ab", 0, 10),
    BenchCase("gpu-512-lab", "cuda", 512, "lab", 2, 10),
    BenchCase("gpu-1024-lab", "cuda", 1024, "lab", 1, 10),
    BenchCase("gpu-2048-lab", "cuda", 2048, "lab", 0, 10),
]
...
def test_bench_color_matcher(case: BenchCase, capsys: pytest.CaptureFixture[str]) -> None:
